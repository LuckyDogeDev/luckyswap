 ...
 *
 * Run this file with scripts/_runGoldMinerV2Simplified.sh
 */
...
methods {
	...
	// overrided methods
	goldnuggetPerBlock() returns (uint256 amount)
	...
	// GOLN token
	GOLN() returns (address) envfree // NOT USED
	goldnuggetToken.balanceOf(address) returns (uint256) // NOT USED
	...
	// Rewarder
	// SIG_ON_GOLN_REWARD = 0xbb6cc2ef; // onGoldNuggetReward(uint256,address,uint256)
	0xbb6cc2ef => NONDET
