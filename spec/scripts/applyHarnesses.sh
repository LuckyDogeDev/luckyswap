...
##################################################
#            Changes to GoldMinerV2             #
##################################################

# SafeTransfer simplification
perl -0777 -i -pe 's/safeT/t/g' contracts/GoldMinerV2.sol

# Adding public to totalAllocPoint
perl -0777 -i -pe 's/uint256 totalAllocPoint/uint256 public totalAllocPoint/g' contracts/GoldMinerV2.sol

# Adding virtual to goldnuggetPerBlock()
perl -0777 -i -pe 's/function goldnuggetPerBlock\(\) public view returns/function goldnuggetPerBlock\(\) public view virtual returns/g' contracts/GoldMinerV2.sol
